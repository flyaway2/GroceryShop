...
public class CheckAccount_Activity extends AppCompatActivity {

    //These are the objects needed
    //It is the verification id that will be sent to the user
    private String mVerificationId,username,mobile;
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(CheckAccount_Activity.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(CheckAccount_Activity.this, new OnCompleteListener<AuthResult>() {
                    @Override
